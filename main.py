...
def get_audio():
	...
	with sr.Microphone() as source:
		#print("Listen ki inka poledhu.....\n") 
		audio = r.listen(source)
		#print("Ardham Ayindha")		
		said = ""
		try:
			print("Recognizing....\n")
...
while True :
	...
	MANASA=["take the complaint", "write down the complaint"]
	if text in MANASA:
	...
	if text in GAMMA:
		print("Answering....")
		speak("G Venkata Sai kishore Sir and contact number is 7 0 3 6 1 2 5 3 3 5")
	...
	if text in DELTA:
		print("Answering....")
		speak("S RavindranathReddy Sir and contact number is 9 0 3 2 7 8 9 8 9 0")
	
	EXAMS=["when are the exams for 3rd year students", "when are the exams for third year students"]
	if text in EXAMS:
		print("Answering....")
		speak("According to the Trusted Sources  Mid one is on april 15 and MId 2 is on april 26 and finally End semester will be in first week of may")

	if "when are the holidays Tokyo" in text:
		print("Answering....")
		speak("According to the Trusted Sources, after end semester you will not have the holidays rather giving holidaysyou will be sent to the SSN Engineering college")
